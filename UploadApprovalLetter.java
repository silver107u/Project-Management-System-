 ...
 * @author dell
 */
public class UploadApprovalLetter extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("user value 1"+userid);
       // D:\\nwe\\userid\\synopsis
        String path= "d:/nwe/"+userid+"/Approval";
...
Connection conn=DBConnection.getConnction();
        ...
        try
        {
                    ...
                    PreparedStatement ps2=conn.prepareStatement("update studentlog set al='yes'where userid=?");
